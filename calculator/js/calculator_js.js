...
//this modifies values each time a butto is clicked on
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //this overwrites Display_Valueif the current value is 0 otherwise it adds onto it
